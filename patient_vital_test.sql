...
SELECT Initial_Assessment.Patient_ID, FName, LName, Patient_Height, Patient_Weight, Patient_Blood_Pressure, Patient_Heart_Rate, Assessment_Date
FROM Initial_Assessment, Patient
WHERE Initial_Assessment.Patient_ID = Patient.Patient_ID;
